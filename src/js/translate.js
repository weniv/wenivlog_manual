...
const translations = {
  ko: {
    ...
    'target-list-2': '지킬(Jekyll)을 이용해 블로그를 만드는데 어려움을 느끼셨던 분',
    'target-list-3': '나만의 개발 블로그를 만들어보고 싶었던 분',
    'target-list-4': '매일 공부한 것을 정리(TIL, Today I Learned)하고 싶으신 분',
  ...
  en: {
    ...
    "target-list-1": "Those who want to write blog posts and grow their GitHub grass at the same time",
    "target-list-2": "Those who experienced difficulties creating a blog using Jekyll",
    "target-list-3": "Those who wanted to create their own development blog",
    "target-list-4": "Those who want to organize what they study every day (TIL, Today I Learned)",
    "target-list-5": "Those who want a blog with code highlighting capabilities",
